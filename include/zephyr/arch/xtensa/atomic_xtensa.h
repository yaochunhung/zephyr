			...
			atomic_val_t newval)
{
    ...
    atomic_val_t tmp;
    __asm__ volatile("l32ex %1, %3; s32ex %0, %3; getex %2"
         : "+r"(newval), "+r"(oldval), "=r"(tmp) : "r"(addr) : "memory");
    return !tmp ? oldval : newval;
...
#else
#warn "Warning: Neither XCHAL_HAVE_EXCLUSIVE nor XCHAL_HAVE_S32C1I is configured"
#endif
}
